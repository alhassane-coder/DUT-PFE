...
<body>
	<div class="jumbotron">
	    ...
	    <a class="btn" href="<?='localhost/Pfe/activation.php?user='.base64_encode($login).'&token='.$token ?>">Activer mon compte</a>
	</div>
    <div class="page-footer"> 

         Copyright &copy 2021  PFE EST Réseaux et Télécom 2eA 	
