    ...
    <div class="main-content">
        ...
        <main>
            ...
            <div class="form-content">
			   ...
			   <h4 style="color: rgb(0, 174, 255); margin-bottom: 10px;">Ajouter un produit</h4>
			   ...
			   <table class="tb-add" align=center cellspacing=10 >
					...
					<tr>
						...
						<td><input type="text" placeholder="Nom du produit:"id="productname" name="productname" value="<?= get_input('productname') ?>"   required="required" data-parsley-minlength="3" data-parsley-trigger="change"></td>
					</tr>
					...
					<tr>
						...
						<td><input type="text" placeholder="Nom famille :"name="familyname" value="<?= get_input('familyname') ?>" required="required" data-parsley-minlength="3" data-parsley-trigger="change"></td>
					</tr>
					...
					<tr>
						...
						<td><input type="number" placeholder="Quantité du produit:"name="qte" value="<?= get_input('qte') ?>" required="required"></td>
					</tr>
					...
					<tr>
						...
						<td><input type="date" placeholder="Date d'expiration:"name="expire_date" value="<?= get_input('expire_date') ?>" required="required" ></td>
					</tr>
					...
					<tr>
						...
						<td><input type="number" placeholder="Prix:"name="price" value="<?= get_input('price') ?>" required="required"></td>
					</tr> 
					...
					<tr>
						...
						<td><input type="text" placeholder="TVA:"name="tva" value="<?= get_input('tva') ?>" required="required"></td>
					</tr>            
     
			    </table>
			    <input type="submit" style="margin-top:10px;" class="submit-btn" value="Ajouer" name="add_product">
