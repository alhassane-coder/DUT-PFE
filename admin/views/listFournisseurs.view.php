        ...
        <main>
            ...
            <?php foreach($fournisseurs as $fournsisseur) : ?>
                <tr>
                    ...
                    <td>
                        <a title="Supprimer le fournisseur" onclick="return confirm('Voulez vous vraiment supprimer ce fournsisseur ?');" class="submit-btn1" href="delFournisseur.php?id=<?=$fournsisseur->id ?>&name=<?=$fournsisseur->name ?>"><i style="font-size:17px;" class="fas fa-trash-alt"></i></a>
                   </td>
                </tr>
